package net.arathain.familiarsorcery.pain;
...
public final class UnfamiliarPackets {
    public static final Identifier SPAWN = new Identifier(FamiliarSorcery.MODID, "spawn");

    private UnfamiliarPackets() {
    }
